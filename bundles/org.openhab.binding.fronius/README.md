...
Number:ElectricPotential Meter_VoltagePhase1 { channel="fronius:meter:mybridge:mymeter:voltageacphase1" }
Number:ElectricPotential Meter_VoltagePhase2 { channel="fronius:meter:mybridge:mymeter:voltageacphase2" }
Number:ElectricPotential Meter_VoltagePhase3 { channel="fronius:meter:mybridge:mymeter:voltageacphase3" }
